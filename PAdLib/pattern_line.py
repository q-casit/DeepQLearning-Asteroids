...
def draw(surface, p1,p2, color_function, section_length,section_offset=0):
    ...
    while True:
        ...
        surface.set_at((x0,y0),color_function( (displacement%section_length)/section_length ))
        ...
        if e2 <  dx:
            err = err + dx
            y0 = y0 + sy
def aadraw(surface, p1,p2, color_function, section_length,section_offset=0, blend=True):
    ...
    def plot(x,y, c):
        ...
        color2 = color_function( (displacement%section_length)/section_length )
        if blend:
