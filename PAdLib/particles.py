...
class Emitter(object):
    ...
    def set_particle_emit_density(self, particles_per_second):
        self.density = particles_per_second
    #degrees_spread is the entire spread of the particles
    def set_particle_emit_angle(self, degrees_angle,degrees_spread=0):
        self.angle = radians(degrees_angle)
        self.spread = radians(degrees_spread)
    def set_particle_emit_speed(self, speed_range):
        self.speed = list(speed_range)
    def set_particle_emit_life(self, life_range):
        self.life = list(life_range)
    def set_particle_emit_colors(self, colors):
        self.colors = list(colors)
